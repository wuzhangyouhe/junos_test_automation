...
import configuring.templates.l3vpn_config_vars_pe3 as define_vars

def conf_l3vpn_service_pe3(hostname, username, password, interface, ce_interface):
    conf_file = "configuring/templates/l3vpn-service-pe3.conf"
