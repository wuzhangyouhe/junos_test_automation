...
import configuring.templates.vpls_config_vars_pe2 as define_vars

def conf_vpls_service_pe2(hostname, username, password, interface, ce_interface):
    conf_file = "configuring/templates/vpls-service-pe2.conf"
