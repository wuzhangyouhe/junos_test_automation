...
import configuring.templates.ngmvpn_config_vars_pe2 as define_vars

def conf_ngmvpn_service_pe2(hostname, username, password, interface, ce_interface):
    conf_file = "configuring/templates/ngmvpn-service-pe2.conf"
