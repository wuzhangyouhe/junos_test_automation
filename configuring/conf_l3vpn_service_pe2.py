...
import configuring.templates.l3vpn_config_vars_pe2 as define_vars

def conf_l3vpn_service_pe2(hostname, username, password, interface, ce_interface):
    conf_file = "configuring/templates/l3vpn-service-pe2.conf"
