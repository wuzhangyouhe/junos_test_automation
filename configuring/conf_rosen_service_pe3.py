...
import configuring.templates.rosen_config_vars_pe3 as define_vars

def conf_rosen_service_pe3(hostname, username, password, interface, ce_interface):
    conf_file = "configuring/templates/rosen-service-pe3.conf"
