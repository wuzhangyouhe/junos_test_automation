...
import configuring.templates.l2circuit_config_vars_local as define_vars
from lxml import etree
import re

def conf_l2circuit_service_local(hostname, remotehost, username, password, interface):
    conf_file = "configuring/templates/l2circuit-service-local.conf"
